...
@Component({
  selector: 'app-template3-create',
  templateUrl: './template3-create.component.html',
  styleUrls: ['./template3-create.component.css']
})
export class Template3CreateComponent implements OnInit {
