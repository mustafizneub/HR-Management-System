...
@Component({
  selector: 'app-adminleaveedit',
  templateUrl: './adminleaveedit.component.html',
  styleUrls: ['./adminleaveedit.component.css']
})
export class AdminleaveeditComponent implements OnInit {
  ...
  submitleaveForm() {
    ...
    this.route.navigate(['/viewadminleave']);
