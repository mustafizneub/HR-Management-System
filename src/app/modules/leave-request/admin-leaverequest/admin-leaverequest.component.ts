...
export class AdminLeaverequestComponent implements OnInit {
  ...
  constructor(private leave: LeaveRequestService, private db: AngularFirestore, private modalService: NgbModal, private fb: FormBuilder, public router: Router) {

  }

  ngOnInit(): void {

    // assign static data start
    var mail = localStorage.getItem("mail");
    // assign static data end
    this.leave.getAdminLeave(mail).valueChanges().subscribe(object => {
